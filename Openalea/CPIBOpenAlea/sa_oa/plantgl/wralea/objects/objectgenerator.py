from sa_oa.core import ScriptLibrary
from sa_oa.core.external import *
import sa_oa.core.interface as intface
from sa_oa.plantgl import math as mt
from sa_oa.plantgl import scenegraph as sg
from sa_oa.plantgl.wralea.edition.pgl_interface import ICurve2D
...
from sa_oa.plantgl.scenegraph._pglsg import Color4
from sa_oa.core.external import add_docstring
@add_docstring(Color4)
def Color4Node(input):
    return [Color4(input)]

from sa_oa.plantgl.scenegraph._pglsg import Color3
from sa_oa.core.external import add_docstring
