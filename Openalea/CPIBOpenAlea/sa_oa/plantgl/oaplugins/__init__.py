...
from sa_oa.oalab.plugins.control import ControlWidgetSelectorPlugin
...
class PluginColorListWidget(ControlWidgetSelectorPlugin):
    ...
    @classmethod
    def load(cls):
        from sa_oa.plantgl.oaplugins.controls import ColorListWidget
...
class PluginMaterialListWidget(ControlWidgetSelectorPlugin):
    ...
    @classmethod
    def load(cls):
        from sa_oa.plantgl.oaplugins.controls import MaterialListWidget
...
class PluginCurve2DWidget(ControlWidgetSelectorPlugin):
    ...
    @classmethod
    def load(cls):
        from sa_oa.plantgl.oaplugins.controls import Curve2DWidget
...
class PluginQuantisedFunctionWidget(ControlWidgetSelectorPlugin):
    ...
    @classmethod
    def load(cls):
        from sa_oa.plantgl.oaplugins.controls import QuantisedFunctionWidget
...
class PluginPatchWidget(ControlWidgetSelectorPlugin):
    ...
    @classmethod
    def load(cls):
        from sa_oa.plantgl.oaplugins.controls import NurbsPatchWidget
