...
from sa_oa.oalab.gui.control.widget import AbstractQtControlWidget
from sa_oa.oalab.plugins.controls.painters import PainterInterfaceObject
from painters import PainterColorList, PainterMaterialList
from sa_oa.plantgl.gui.materialeditor import MaterialEditor
from sa_oa.plantgl.all import PglTurtle, EditableQuantisedFunction
...
def to_material(color_list):
    ...
    from sa_oa.plantgl.all import Material, Color3
    material_list = []
...
from sa_oa.plantgl.gui.curve2deditor import Curve2DEditor, FuncConstraint
...
from sa_oa.plantgl.gui.nurbspatcheditor import NurbsPatchEditor
