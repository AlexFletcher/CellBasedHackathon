...
from sa_oa.core.interface import IInterface
...
class IColorList(IInterface):
    ...
    def sample(self):
        ...
        """
        from sa_oa.plantgl.all import Color3
        value = [
...
class IMaterialList(IInterface):
    ...
    def sample(self):
        ...
        Reinitialize control to default value
        """
        from sa_oa.plantgl.all import Material, PglTurtle

        value = PglTurtle().getColorList()
        return value

    def module_dependence(self):
        return 'sa_oa.plantgl.all'
...
class ICurve2D(IInterface):
    ...
    def sample(self):
        ...
        Reinitialize control to default value
        """
        from sa_oa.plantgl.all import NurbsCurve2D, Point3Array, Vector3
        curve = NurbsCurve2D(
            Point3Array([
                Vector3(-0.5, 0, 1),
...
class IQuantisedFunction(IInterface):
    ...
    def default(self):
        ...
        Reinitialize control to default value
        """
        from sa_oa.plantgl.all import EditableQuantisedFunction, NurbsCurve2D
        nbP = 4
...
class IPatch(IInterface):
    ...
    def default(self):
        ...
        Reinitialize control to default value
        """
        from sa_oa.plantgl.all import NurbsPatch 
